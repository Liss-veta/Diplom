        ...
        <v-form>
            <v-row>
                <v-col cols="12" md="6">
                    ...
                    <v-text-field v-model="form.email" label="Электронная почта"
                ...
                <v-col cols="12" md="4">
                    <v-select v-model="form.select" :items="form.items" :error-messages="selectErrors"
                        label="Пол"></v-select>
                </v-col>
                <v-col cols="12" md="4">
                ...
                <v-col cols="12" md="4">
                    <v-combobox v-model="form.selectN" :items="form.napravlenie" :error-messages="selectNErrors"
                        label="Выберите ваши направления" multiple chips></v-combobox>
                </v-col>
            </v-row>
            <v-row>
                <v-col cols="12" md="4">
            ...
            <v-row>
                <v-col cols="12" md="8">
                    <v-text-field v-model="form.opisanie" :counter="200" label="Оставьте ваше описание для профиля"
                        :error-messages="opisanieErrors"></v-text-field>
                </v-col>
            </v-row>
            <v-row>
                <v-col cols="12" md="4">
